...
<div class="History">
    ...
    <div class="containerFilter">
        <div class="side-menu-profile filterBar">
            ...
            <div class="filterMargin">
                <label class="titreCommentaire" for="commentaire">Demandée le</label>
        ...
        <div class="list_conge">
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= $dates[$i]["name"];?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= $dates[$i]["name"];?></p>
                    <?php }
                }
                ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= date("d/m/Y H:i", strtotime($dates[$i]["created_at"]))?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= date("d/m/Y H:i", strtotime($dates[$i]["created_at"]))?></p>
                    <?php }
                }
                ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= $dates[$i]["first_name"]." ".$dates[$i]["last_name"]; ?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= $dates[$i]["first_name"]." ".$dates[$i]["last_name"]; ?></p>
                    <?php }
                }
                ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= date("d/m/Y H:i", strtotime($dates[$i]["start_at"])); ?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= date("d/m/Y H:i", strtotime($dates[$i]["start_at"])); ?></p>
                    <?php }
                }
                ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= date("d/m/Y H:i", strtotime($dates[$i]["end_at"])); ?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= date("d/m/Y H:i", strtotime($dates[$i]["end_at"])); ?></p>
                    <?php }
                }
                ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    if( $i === Count($dates)-1){ ?>
                        <p class="info"><?= $dates[$i]["DateDiff"]; ?></p>
                    <?php } else{ ?>
                        <p class="info filterBorderBottom"><?= $dates[$i]["DateDiff"]; ?></p>
                    <?php }
                } ?>
            </div>
            <div class="congeType">
                ...
                for ($i = 0; $i < Count($dates); $i++){
                    ...
                    <div class="infoDetail">
                        <a class="details-button" href="*" style="text-decoration: none;">Details</a>
                    </div>
                    <?php } else{ ?>
