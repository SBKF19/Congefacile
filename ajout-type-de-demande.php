...
<div class="History">
        ...
        <button class="dark-button">Ajouter un type de demande</button>
        </div>
                ...
                <div class="list_conge">
                        <div class="congeType large-filter">
                            <?php
                                for ($i = 0; $i < Count($postes); $i++){
                                    if( $i === Count($postes)-1){ ?>
                                        <p class="info break-details"><?= $postes[$i]['typeRequette']?></p>
                                    <?php } else{ ?>
                                        <p class="info filterBorderBottom break-details"><?= $postes[$i]['typeRequette']?></p>
                                    <?php }
                                }
                            ?>
                        </div>
                        <div class="congeType medium-filter">
                            <?php
                                for ($i = 0; $i < Count($postes); $i++){
                                    if( $i === Count($postes)-1){ ?>
                                        <p class="info break-details"><?= $postes[$i]['nbPersonnesAssociees']?></p>
                                    <?php } else{ ?>
                                        <p class="info filterBorderBottom break-details"><?= $postes[$i]['nbPersonnesAssociees']?></p>
                                    <?php }
                                }
                            ?>
                        </div>
